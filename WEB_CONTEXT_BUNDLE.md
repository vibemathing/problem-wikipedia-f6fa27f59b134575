...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-f6fa27f59b134575",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-f6fa27f59b134575",
    ...
    "statement": {
      "language": "en",
      "text": "Crouzeix's conjecture : the matrix norm of a complex function $f$ applied to a complex matrix $A$ is at most twice the supremum of $|f(z)|$ over the field of values of $A$ .",
      "version": 1
    },
    "title": "Crouzeix's conjecture",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "71b23e3c62741fef649529c466e5f1c612c96ee37e11756ecf4375f11c6d969f"
}
```
